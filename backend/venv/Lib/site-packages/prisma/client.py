...
SCHEMA_PATH = Path('C:/Users/ANKIT/Documents/github_proj/Memory-Lane/Memory-Lane/backend/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'windows': 'C:\\Users\\ANKIT\\.cache\\prisma-python\\binaries\\5.17.0\\393aa359c9ad4a4bb28630fb5613f9c281cde053\\node_modules\\prisma\\query-engine-windows.exe'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    audio: 'actions.AudioActions[models.Audio]'
    ...
    def __init__(
        ...
        *,
        ...
        self.audio = actions.AudioActions[models.Audio](self, models.Audio)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': 'C:/Users/ANKIT/Documents/github_proj/Memory-Lane/Memory-Lane/backend/prisma/schema.prisma',
        }
...
class Batch:
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.audio = AudioBatchActions(self)
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class AudioBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher

    def create(
        self,
        data: types.AudioCreateInput,
        include: Optional[types.AudioInclude] = None
    ) -> None:
        self._batcher._add(
            method='create',
            model=models.Audio,
    ...
    def create_many(
        self,
        data: List[types.AudioCreateWithoutRelationsInput],
        *,
        skip_duplicates: Optional[bool] = None,
    ) -> None:
        if skip_duplicates and self._batcher._active_provider in CREATE_MANY_SKIP_DUPLICATES_UNSUPPORTED:
    ...
    def delete(
        self,
        where: types.AudioWhereUniqueInput,
        include: Optional[types.AudioInclude] = None,
    ) -> None:
        self._batcher._add(
            method='delete',
    ...
    def update_many(
        self,
        data: types.AudioUpdateManyMutationInput,
        where: types.AudioWhereInput,
    ) -> None:
        self._batcher._add(
            method='update_many',
            model=models.Audio,
    ...
    def delete_many(
        self,
        where: Optional[types.AudioWhereInput] = None,
    ) -> None:
        self._batcher._add(
            method='delete_many',
            model=models.Audio,
