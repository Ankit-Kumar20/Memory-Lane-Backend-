...
class BaseAudio(_PrismaModel):
    __prisma_model__: ClassVar[Literal['Audio']] = 'Audio'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.AudioActions[_PrismaModelT]':
        from .client import get_client

        return actions.AudioActions[_PrismaModelT](client or get_client(), cls)
